...
| <a class = 'callink' href ='https://github.com/thomasgstewart/data-science-5620-fall-2020/blob/master/deliverables/06-order-statistics.md'>Order Statistics</a> | 2020-10-19 | 2020-11-11 |
...
|---|:---:|:---:|---|
| Class logistics | | |<a href='https://vbiostat2.app.vumc.org/index.php/s/BNNBgE4frZEaQC2'>Calendar/Polices</a> |
...
| **Basic Probability Ideas** | [slides](https://biostatdata.app.vumc.org/tgs/03-probability-basics-slides.html) <br> [slides part 2](https://biostatdata.app.vumc.org/tgs/04-probability-basics-part2-slides.html) | 1 | [lecture 1](https://vbiostat2.app.vumc.org/index.php/s/ZTp9GkFBqHzo5oG) <br> [lecture 2](https://vbiostat2.app.vumc.org/index.php/s/HPgzdztncLnHqob) |
|  → Belief vs Frequency  | | | |
...
|  → Bayes Rule | [slides](./lectures/04-probability-bayes-rule.pdf) <br> [slides part 2](./lectures/04-more-bayes.pdf) | 1.9 | [Lecture](https://vbiostat2.app.vumc.org/index.php/s/QiGcZmD7Rk8C7k9) <br> [Lecture](https://vbiostat2.app.vumc.org/index.php/s/W6dXZFjsop3HW8K) <br> [coin toss](https://vbiostat2.app.vumc.org/index.php/s/xRB9aMDC4AEn5di)|
| **Discrete Probability Models** | | 3, 4, 5 | |
| → Bernouli Random Variables | [slides](https://biostatdata.app.vumc.org/tgs/05-binomial-prob.html) | | [Lecture - Binomial, Negative binomial](https://vbiostat2.app.vumc.org/index.php/s/tfH5MayYYnaotk8) |
| → Binomial Random Variables | [slides](https://biostatdata.app.vumc.org/tgs/05-binomial-prob.html)| | [Lecture - Binomial, Negative binomial](https://vbiostat2.app.vumc.org/index.php/s/tfH5MayYYnaotk8) |
| → Negative Binomial Random Variables | [slides](https://biostatdata.app.vumc.org/tgs/05-binomial-prob.html) | | [Lecture - Binomial, Negative binomial](https://vbiostat2.app.vumc.org/index.php/s/tfH5MayYYnaotk8) <br> [Lecture - Binomial, Negative binomial (cont)](https://vbiostat2.app.vumc.org/index.php/s/H3wYDm89L5sp6qW)  |
| → Poisson Random Variables | [slides](https://biostatdata.app.vumc.org/tgs/06-poisson.html) | | [Lecture - Poisson distribution](https://vbiostat2.app.vumc.org/index.php/s/77iw36kT3YB5TfR) |
| → Probability Mass Function | [slides](https://biostatdata.app.vumc.org/tgs/07-pmf-cdf.html)| | [Lecture - World Series distribution](https://vbiostat2.app.vumc.org/index.php/s/EmS88pZXriYTZPt) |
| **Continuous Probability Models** | | 6 | |
| → Cumulative Distribution Function | [slides](https://biostatdata.app.vumc.org/tgs/08-continuous-probability-models.html) | | [Lecture - Continuous probability models](https://vbiostat2.app.vumc.org/index.php/s/93FxTFYLEc8LTdo) |
| → Probability Density Function | [slides](https://biostatdata.app.vumc.org/tgs/08-continuous-probability-models.html) | | [Lecture - Continuous probability models](https://vbiostat2.app.vumc.org/index.php/s/93FxTFYLEc8LTdo) |
| → Uniform Random Variables  | [slides](https://biostatdata.app.vumc.org/tgs/09-continuous-probability-models-part2.html)| |  [Lecture](https://vbiostat2.app.vumc.org/index.php/s/MxBX2zMrHsz2RHL) <br> [Lecture](https://vbiostat2.app.vumc.org/index.php/s/9GR9DyFAybmTxfZ) <br> [Practice Problems](https://vbiostat2.app.vumc.org/index.php/s/qMqomiK8F7Cs55a) |
| → Normal Random Variables  | [slides](https://biostatdata.app.vumc.org/tgs/09-continuous-probability-models-part2.html) | | [Lecture](https://vbiostat2.app.vumc.org/index.php/s/MxBX2zMrHsz2RHL) <br> [Lecture](https://vbiostat2.app.vumc.org/index.php/s/9GR9DyFAybmTxfZ) <br> [Practice Problems](https://vbiostat2.app.vumc.org/index.php/s/qMqomiK8F7Cs55a) |
| → Exponential Random Variables  | [slides](https://biostatdata.app.vumc.org/tgs/09-continuous-probability-models-part2.html) | |  [Lecture](https://vbiostat2.app.vumc.org/index.php/s/MxBX2zMrHsz2RHL) <br> [Lecture](https://vbiostat2.app.vumc.org/index.php/s/9GR9DyFAybmTxfZ) <br> [Practice Problems](https://vbiostat2.app.vumc.org/index.php/s/qMqomiK8F7Cs55a) |
| → Gamma Random Variables  | [slides](https://biostatdata.app.vumc.org/tgs/09-continuous-probability-models-part2.html) | |  [Lecture](https://vbiostat2.app.vumc.org/index.php/s/MxBX2zMrHsz2RHL) <br> [Lecture](https://vbiostat2.app.vumc.org/index.php/s/9GR9DyFAybmTxfZ) <br> [Practice Problems](https://vbiostat2.app.vumc.org/index.php/s/qMqomiK8F7Cs55a) |
